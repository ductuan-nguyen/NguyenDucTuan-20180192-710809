...
public class CartScreenHandler extends BaseScreenHandler {
	...
	@FXML
	private ToggleButton rushOrderToggle;
	...
	public void requestToPlaceOrder() throws SQLException, IOException {
		try {
			...
			if (placeOrderController.getListCartMedia().size() == 0){
				PopupScreen.error("You don't have anything to place order");
				return;
			}
			...
			ShippingScreenHandler.setVisibleInRush(rushOrderToggle.isSelected());
